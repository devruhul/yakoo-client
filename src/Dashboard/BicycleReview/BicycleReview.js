        ...
        <form onSubmit={handleBicycleReview} className="flex w-full max-w-xl space-y-3 mx-auto">
            <div className="w-full  px-5 py-5 m-auto bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div className="grid  grid-cols-2 gap-6 mx-auto">
                    ...
                    <div className="col-span-2 lg:col-span-2">
                        <div className=" relative ">
                            <input name="companyName" type="text" id="contact-form-company-name" className="flex-1 appearance-none border border-pink-300 w-full py-2 px-4 bg-white text-purple-color placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                                required
                                onChange={handleOnChange}
