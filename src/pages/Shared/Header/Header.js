    ...
    <div className='navbar bg-base-100 '>
      <div className='navbar-start'>
        <div className='dropdown'>
          ...
          <ul className='menu menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-100 bg-footer-bg'>
            ...
            <Link to='contact'>
              <li>
                <button className='btn btn-ghost normal-case text-xl mb-2'>
                  Contact
                </button>
              </li>
            </Link>
        ...
        <Link to='/'>
          <button className='btn btn-ghost normal-case text-xl'>Yokoo</button>
        </Link>
      </div>
      ...
      <div className='navbar-center hidden lg:flex'>
        <ul className='menu menu-horizontal p-0 '>
          <Link to='/'>
            <li>
              <button className='btn btn-ghost normal-case text-base'>
                Home
              </button>
            </li>
          </Link>
      ...
      <div className='navbar-end'>
        ...
        {yokooUser?.email && (
          <button
            onClick={yokooUserlogout}
            className=' btn btn-primary ml-5 xs:hidden'
          >
            Logout
          </button>
        )}
