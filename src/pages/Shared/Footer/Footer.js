      ...
      <div className='container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
        ...
        <div className='flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center'>
          ...
          <div className='w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:ml-3 space-y-3'>
            ...
            <p className='mt-2 text-base text-white'>
              Our award-winning stores are the heart and soul of our company - a
              haven for cyclists of all levels and disciplines.
            </p>
          </div>
        </div>
      </div>
      <div className='bg-gray-400'>
        <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
          ...
          <span className='inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start text-lg'>
            <a
              href='https://www.facebook.com/devruhulaminmahfuj'
              target='_blank'
              rel='noreferrer'
            >
