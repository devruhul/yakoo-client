          ...
          <div className='flex flex-col mb-4'>
            <div className='flex relative '>
              ...
              <input
                ...
                onBlur={handleOnBlur}
                id='sign-up-name'
                className='flex-1 appearance-none border border-pink-300 w-full py-3 px-4 bg-white text-purple-color placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent'
