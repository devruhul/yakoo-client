        ...
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 inline-flex w-60 bg-footer-bg ">
                    ...
                    {admin && <li><Link to='/dashboard/bookingsLists'>All Orders</Link></li>}
                    {!admin && <li><Link to='/dashboard/payment'>Pay</Link></li>}
                    {!admin && <li><Link to='/dashboard/myOrders'>My Orders</Link></li>}
                    {!admin && <li><Link to='/dashboard/bicycleReview'>Review</Link></li>}
                </ul>
            </div>
        </div>
    );
